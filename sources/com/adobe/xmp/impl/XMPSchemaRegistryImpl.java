...
public final class XMPSchemaRegistryImpl implements XMPSchemaRegistry, XMPConst {
    ...
    /* renamed from: p */
    private Pattern f70p = Pattern.compile("[/*?\\[\\]]");
    ...
    private void registerStandardNamespaces() throws XMPException {
        ...
        registerNamespace(XMPConst.NS_JPEG, PhotoModule.PIXEL_FORMAT_JPEG);
    ...
    public synchronized void registerAlias(String str, String str2, String str3, String str4, AliasOptions aliasOptions) throws XMPException {
        ...
        if (this.f70p.matcher(str2).find() || this.f70p.matcher(str4).find()) {
    ...
    private void registerStandardAliases() throws XMPException {
        ...
        registerAlias(XMPConst.NS_PDF, "Title", XMPConst.NS_DC, TinyPlanetFragment.ARGUMENT_TITLE, aliasOptions);
        ...
        registerAlias(XMPConst.NS_PHOTOSHOP, "Title", XMPConst.NS_DC, TinyPlanetFragment.ARGUMENT_TITLE, arrayAltText);
        ...
        registerAlias(XMPConst.NS_PNG, "Title", XMPConst.NS_DC, TinyPlanetFragment.ARGUMENT_TITLE, arrayAltText);
    }
}
