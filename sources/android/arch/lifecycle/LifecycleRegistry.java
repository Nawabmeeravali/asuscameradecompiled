...
public class LifecycleRegistry extends Lifecycle {
    ...
    static /* synthetic */ class C00071 {
        ...
        static {
            ...
            L_0x0091:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: android.arch.lifecycle.LifecycleRegistry.C00071.<clinit>():void");
        }
    }
    ...
    static State getStateAfter(Event event) {
        switch (C00071.$SwitchMap$androidx$lifecycle$Lifecycle$Event[event.ordinal()]) {
            case 1:
            case 2:
    ...
    private static Event downEvent(State state) {
        int i = C00071.$SwitchMap$androidx$lifecycle$Lifecycle$State[state.ordinal()];
        if (i == 1) {
