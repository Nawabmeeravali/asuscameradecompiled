...
public final class ResourcesCompat {
    ...
    private static android.graphics.Typeface loadFont(@android.support.annotation.NonNull android.content.Context r15, android.content.res.Resources r16, android.util.TypedValue r17, int r18, int r19, @android.support.annotation.Nullable android.support.p000v4.content.res.ResourcesCompat.FontCallback r20, @android.support.annotation.Nullable android.os.Handler r21, boolean r22) {
        ...
        L_0x0032:
            ...
            android.support.v4.content.res.FontResourcesParserCompat$FamilyResourceEntry r2 = android.support.p000v4.content.res.FontResourcesParserCompat.parse(r1, r0)     // Catch:{ XmlPullParserException -> 0x008c, IOException -> 0x0076 }
        ...
        L_0x0053:
            ...
            r7 = r21
            r8 = r22
            android.graphics.Typeface r0 = android.support.p000v4.graphics.TypefaceCompat.createFromResourcesFamilyXml(r1, r2, r3, r4, r5, r6, r7, r8)     // Catch:{ XmlPullParserException -> 0x008c, IOException -> 0x0076 }
            return r0
        L_0x0065:
            r1 = r15
            android.graphics.Typeface r0 = android.support.p000v4.graphics.TypefaceCompat.createFromResourcesFontFile(r15, r0, r4, r12, r5)     // Catch:{ XmlPullParserException -> 0x008c, IOException -> 0x0076 }
