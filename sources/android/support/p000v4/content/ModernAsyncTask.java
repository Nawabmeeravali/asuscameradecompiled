...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    static /* synthetic */ class C01234 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p000v4.content.ModernAsyncTask.C01234.<clinit>():void");
        }
    }
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor executor, Params... paramsArr) {
        if (this.mStatus != Status.PENDING) {
            int i = C01234.$SwitchMap$androidx$loader$content$ModernAsyncTask$Status[this.mStatus.ordinal()];
            if (i == 1) {
