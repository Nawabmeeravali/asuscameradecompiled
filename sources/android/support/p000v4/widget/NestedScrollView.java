    ...
    public boolean executeKeyEvent(@NonNull KeyEvent keyEvent) {
        ...
        if (!canScroll) {
            if (isFocused() && keyEvent.getKeyCode() != 4) {
                ...
                View findNextFocus = FocusFinder.getInstance().findNextFocus(this, findFocus, Const.CODE_C1_CW2);
                if (!(findNextFocus == null || findNextFocus == this || !findNextFocus.requestFocus(Const.CODE_C1_CW2))) {
                    z = true;
                }
            }
            return z;
        ...
        if (keyEvent.getAction() == 0) {
            ...
            if (keyCode == 19) {
                ...
                z = !keyEvent.isAltPressed() ? arrowScroll(Const.CODE_C1_CW2) : fullScroll(Const.CODE_C1_CW2);
            } else if (keyCode == 62) {
