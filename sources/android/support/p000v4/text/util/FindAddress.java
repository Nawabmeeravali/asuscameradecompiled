...
class FindAddress {
    ...
    /* renamed from: NL */
    private static final String f56NL = "\n\u000b\f\r  ";

    /* renamed from: SP */
    private static final String f57SP = "\t                　";
    private static final String WORD_DELIM = ",*•\t                　\n\u000b\f\r  ";
    private static final String WORD_END = "(?=[,*•\t                　\n\u000b\f\r  ]|$)";

    /* renamed from: WS */
    private static final String f58WS = "\t                　\n\u000b\f\r  ";
    ...
    private static int attemptMatch(java.lang.String r13, java.util.regex.MatchResult r14) {
        ...
        L_0x00dd:
            ...
            return r13
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p000v4.text.util.FindAddress.attemptMatch(java.lang.String, java.util.regex.MatchResult):int");
    }
