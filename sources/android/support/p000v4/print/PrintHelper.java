...
public final class PrintHelper {
    ...
    public void writeBitmap(PrintAttributes printAttributes, int i, Bitmap bitmap, ParcelFileDescriptor parcelFileDescriptor, CancellationSignal cancellationSignal, WriteResultCallback writeResultCallback) {
        ...
        C04231 r2 = new AsyncTask<Void, Void, Throwable>() {
            /* access modifiers changed from: protected */
            ...
            public java.lang.Throwable doInBackground(java.lang.Void... r8) {
                /*
                    r7 = this;
                    android.os.CancellationSignal r8 = r4     // Catch:{ all -> 0x00ea }
                    boolean r8 = r8.isCanceled()     // Catch:{ all -> 0x00ea }
                    r0 = 0
                    if (r8 == 0) goto L_0x000a
                    return r0
                L_0x000a:
                    android.print.pdf.PrintedPdfDocument r8 = new android.print.pdf.PrintedPdfDocument     // Catch:{ all -> 0x00ea }
                    android.support.v4.print.PrintHelper r1 = android.support.p000v4.print.PrintHelper.this     // Catch:{ all -> 0x00ea }
                    android.content.Context r1 = r1.mContext     // Catch:{ all -> 0x00ea }
                    android.print.PrintAttributes r2 = r5     // Catch:{ all -> 0x00ea }
                    r8.<init>(r1, r2)     // Catch:{ all -> 0x00ea }
                    android.graphics.Bitmap r1 = r6     // Catch:{ all -> 0x00ea }
                    android.print.PrintAttributes r2 = r5     // Catch:{ all -> 0x00ea }
                    int r2 = r2.getColorMode()     // Catch:{ all -> 0x00ea }
                    android.graphics.Bitmap r1 = android.support.p000v4.print.PrintHelper.convertBitmapForColorMode(r1, r2)     // Catch:{ all -> 0x00ea }
                    android.os.CancellationSignal r2 = r4     // Catch:{ all -> 0x00ea }
                    boolean r2 = r2.isCanceled()     // Catch:{ all -> 0x00ea }
                    if (r2 == 0) goto L_0x002c
                    return r0
                L_0x002c:
                    r2 = 1
                    android.graphics.pdf.PdfDocument$Page r3 = r8.startPage(r2)     // Catch:{ all -> 0x00d5 }
                    boolean r4 = android.support.p000v4.print.PrintHelper.IS_MIN_MARGINS_HANDLING_CORRECT     // Catch:{ all -> 0x00d5 }
                ...
                L_0x0045:
                    ...
                    android.support.v4.print.PrintHelper r5 = android.support.p000v4.print.PrintHelper.this     // Catch:{ all -> 0x00d5 }
                    android.content.Context r5 = r5.mContext     // Catch:{ all -> 0x00d5 }
                    android.print.PrintAttributes r6 = r7     // Catch:{ all -> 0x00d5 }
                    ...
                    r2 = r5
                L_0x006a:
                    int r4 = r1.getWidth()     // Catch:{ all -> 0x00d5 }
                    int r5 = r1.getHeight()     // Catch:{ all -> 0x00d5 }
                    int r6 = r8     // Catch:{ all -> 0x00d5 }
                    android.graphics.Matrix r4 = android.support.p000v4.print.PrintHelper.getMatrix(r4, r5, r2, r6)     // Catch:{ all -> 0x00d5 }
                    boolean r5 = android.support.p000v4.print.PrintHelper.IS_MIN_MARGINS_HANDLING_CORRECT     // Catch:{ all -> 0x00d5 }
                ...
                L_0x008d:
                    ...
                    r8.finishPage(r3)     // Catch:{ all -> 0x00d5 }
                    android.os.CancellationSignal r2 = r4     // Catch:{ all -> 0x00d5 }
                    boolean r2 = r2.isCanceled()     // Catch:{ all -> 0x00d5 }
                    if (r2 == 0) goto L_0x00b3
                    r8.close()     // Catch:{ all -> 0x00ea }
                    android.os.ParcelFileDescriptor r8 = r9     // Catch:{ all -> 0x00ea }
                    if (r8 == 0) goto L_0x00ab
                    android.os.ParcelFileDescriptor r8 = r9     // Catch:{ IOException -> 0x00ab }
                    r8.close()     // Catch:{ IOException -> 0x00ab }
                L_0x00ab:
                    android.graphics.Bitmap r7 = r6     // Catch:{ all -> 0x00ea }
                ...
                L_0x00b3:
                    ...
                    android.os.ParcelFileDescriptor r3 = r9     // Catch:{ all -> 0x00d5 }
                    java.io.FileDescriptor r3 = r3.getFileDescriptor()     // Catch:{ all -> 0x00d5 }
                    r2.<init>(r3)     // Catch:{ all -> 0x00d5 }
                    r8.writeTo(r2)     // Catch:{ all -> 0x00d5 }
                    r8.close()     // Catch:{ all -> 0x00ea }
                    android.os.ParcelFileDescriptor r8 = r9     // Catch:{ all -> 0x00ea }
                    if (r8 == 0) goto L_0x00cd
                    android.os.ParcelFileDescriptor r8 = r9     // Catch:{ IOException -> 0x00cd }
                ...
                L_0x00d5:
                    ...
                    android.os.ParcelFileDescriptor r8 = r9     // Catch:{ IOException -> 0x00e2 }
                ...
                L_0x00ea:
                    ...
                    return r7
                */
                throw new UnsupportedOperationException("Method not decompiled: android.support.p000v4.print.PrintHelper.C04231.doInBackground(java.lang.Void[]):java.lang.Throwable");
            }
