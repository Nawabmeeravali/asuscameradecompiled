...
final class BackStackRecord extends FragmentTransaction implements BackStackEntry, OpGenerator {
    ...
    @Nullable
    String mName;
    ArrayList<C0086Op> mOps = new ArrayList<>();
    int mPopEnterAnim;
    int mPopExitAnim;
    ...
    static final class C0086Op {
        ...
        C0086Op(int i, Fragment fragment2) {
            this.cmd = i;
    ...
    public void dump(String str, PrintWriter printWriter, boolean z) {
        ...
        if (!this.mOps.isEmpty()) {
            ...
            for (int i = 0; i < size; i++) {
                C0086Op op = (C0086Op) this.mOps.get(i);
                switch (op.cmd) {
                    case 0:
                        str2 = "NULL";
                        break;
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C0086Op(3, fragment));
        return this;
    }

    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C0086Op(4, fragment));
        return this;
    }

    public FragmentTransaction show(Fragment fragment) {
        addOp(new C0086Op(5, fragment));
        return this;
    }

    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C0086Op(6, fragment));
        return this;
    }

    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C0086Op(7, fragment));
        return this;
    }

    public FragmentTransaction setPrimaryNavigationFragment(@Nullable Fragment fragment) {
        addOp(new C0086Op(8, fragment));
        return this;
    }
    ...
    public void bumpBackStackNesting(int i) {
        if (this.mAddToBackStack) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                C0086Op op = (C0086Op) this.mOps.get(i2);
    ...
    public boolean interactsWith(int i) {
        int size = this.mOps.size();
        for (int i2 = 0; i2 < size; i2++) {
            Fragment fragment = ((C0086Op) this.mOps.get(i2)).fragment;
    ...
    public boolean interactsWith(ArrayList<BackStackRecord> arrayList, int i, int i2) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            Fragment fragment = ((C0086Op) this.mOps.get(i4)).fragment;
            ...
            if (!(i5 == 0 || i5 == i3)) {
                for (int i6 = i; i6 < i2; i6++) {
                    ...
                    for (int i7 = 0; i7 < size2; i7++) {
                        Fragment fragment2 = ((C0086Op) backStackRecord.mOps.get(i7)).fragment;
    ...
    public void executePopOps(boolean z) {
        for (int size = this.mOps.size() - 1; size >= 0; size--) {
            C0086Op op = (C0086Op) this.mOps.get(size);
            Fragment fragment = op.fragment;
            if (fragment != null) {
            ...
            if (i2 != 1) {
                if (i2 == 2) {
                        ...
                        if (fragment5.mContainerId == i3) {
                            if (fragment5 == fragment3) {
                                ...
                                if (fragment5 == fragment4) {
                                    this.mOps.add(i4, new C0086Op(9, fragment5));
                                    i4++;
                                    fragment4 = null;
                                }
                                C0086Op op2 = new C0086Op(3, fragment5);
                    ...
                    if (fragment6 == fragment2) {
                        this.mOps.add(i, new C0086Op(9, fragment6));
                        i++;
                        fragment2 = null;
                    }
                } else if (i2 != 7) {
                    if (i2 == 8) {
                        this.mOps.add(i, new C0086Op(9, fragment2));
                        i++;
    ...
    public boolean isPostponed() {
        for (int i = 0; i < this.mOps.size(); i++) {
            if (isFragmentPostponed((C0086Op) this.mOps.get(i))) {
                return true;
            }
        }
        return false;
    ...
    private static boolean isFragmentPostponed(C0086Op op) {
        Fragment fragment = op.fragment;
