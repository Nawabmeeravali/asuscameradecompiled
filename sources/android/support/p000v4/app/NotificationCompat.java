...
public class NotificationCompat {
    ...
    public static final class CarExtender implements Extender {
        ...
        /* JADX WARNING: type inference failed for: r1v1, types: [android.support.v4.app.NotificationCompat$CarExtender$UnreadConversation] */
        /* JADX WARNING: type inference failed for: r1v2 */
        /* JADX WARNING: type inference failed for: r8v0, types: [android.support.v4.app.RemoteInput] */
        /* JADX WARNING: type inference failed for: r6v0, types: [android.support.v4.app.NotificationCompat$CarExtender$UnreadConversation] */
        /* JADX WARNING: type inference failed for: r12v1, types: [android.support.v4.app.RemoteInput] */
        /* JADX WARNING: type inference failed for: r6v4, types: [android.support.v4.app.NotificationCompat$CarExtender$UnreadConversation] */
        /* JADX WARNING: type inference failed for: r12v2, types: [android.support.v4.app.RemoteInput] */
        /* JADX WARNING: Multi-variable type inference failed. Error: jadx.core.utils.exceptions.JadxRuntimeException: No candidate types for var: r1v0
          assigns: [?[int, float, boolean, short, byte, char, OBJECT, ARRAY], android.support.v4.app.NotificationCompat$CarExtender$UnreadConversation, android.support.v4.app.RemoteInput]
          uses: [android.support.v4.app.NotificationCompat$CarExtender$UnreadConversation, ?[OBJECT, ARRAY], android.support.v4.app.RemoteInput]
          mth insns count: 59
        ...
        private static android.support.p000v4.app.NotificationCompat.CarExtender.UnreadConversation getUnreadConversationFromBundle(@android.support.annotation.Nullable android.os.Bundle r19) {
            /*
                r0 = r19
                r1 = 0
            ...
            L_0x008a:
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p000v4.app.NotificationCompat.CarExtender.getUnreadConversationFromBundle(android.os.Bundle):android.support.v4.app.NotificationCompat$CarExtender$UnreadConversation");
        }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private android.widget.RemoteViews createRemoteViews(android.widget.RemoteViews r7, boolean r8) {
            /*
                ...
                int r3 = android.support.compat.C0022R.C0024id.actions
            ...
            L_0x0021:
                ...
                int r5 = android.support.compat.C0022R.C0024id.actions
                r0.addView(r5, r4)
                int r3 = r3 + 1
                goto L_0x0021
            L_0x0039:
            ...
            L_0x003d:
                r2 = 8
            L_0x003f:
                int r8 = android.support.compat.C0022R.C0024id.actions
                r0.setViewVisibility(r8, r2)
                int r8 = android.support.compat.C0022R.C0024id.action_divider
                r0.setViewVisibility(r8, r2)
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            remoteViews.setImageViewBitmap(C0022R.C0024id.action_image, createColoredBitmap(action.getIcon(), this.mBuilder.mContext.getResources().getColor(C0022R.color.notification_action_color_filter)));
            remoteViews.setTextViewText(C0022R.C0024id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0022R.C0024id.action_container, action.actionIntent);
            }
            if (VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0022R.C0024id.action_container, action.title);
            }
            return remoteViews;
        }
    }
    ...
    public static class MessagingStyle extends Style {
        ...
        public static final class Message {
            ...
            private Bundle toBundle() {
                ...
                if (uri != null) {
                    bundle.putParcelable(TinyPlanetFragment.ARGUMENT_URI, uri);
                }
                Bundle bundle2 = this.mExtras;
                if (bundle2 != null) {
            ...
            static Message getMessageFromBundle(Bundle bundle) {
                String str = TinyPlanetFragment.ARGUMENT_URI;
                String str2 = "extras";
                String str3 = "type";
                String str4 = "sender";
                String str5 = "sender_person";
                String str6 = "person";
                String str7 = "time";
                String str8 = "text";
                try {
                    if (bundle.containsKey(str8)) {
                        if (bundle.containsKey(str7)) {
                            Person person = bundle.containsKey(str6) ? Person.fromBundle(bundle.getBundle(str6)) : (!bundle.containsKey(str5) || VERSION.SDK_INT < 28) ? bundle.containsKey(str4) ? new android.support.p000v4.app.Person.Builder().setName(bundle.getCharSequence(str4)).build() : null : Person.fromAndroidPerson((Person) bundle.getParcelable(str5));
    ...
    public static abstract class Style {
        ...
        public android.widget.RemoteViews applyStandardTemplate(boolean r13, int r14, boolean r15) {
            ...
            L_0x0023:
                ...
                int r14 = android.support.compat.C0022R.C0024id.notification_background
                int r4 = android.support.compat.C0022R.C0023drawable.notification_bg_low
                r7.setInt(r14, r2, r4)
                int r14 = android.support.compat.C0022R.C0024id.icon
                int r4 = android.support.compat.C0022R.C0023drawable.notification_template_icon_low_bg
                r7.setInt(r14, r2, r4)
                goto L_0x004e
            L_0x0040:
                int r14 = android.support.compat.C0022R.C0024id.notification_background
                int r4 = android.support.compat.C0022R.C0023drawable.notification_bg
                r7.setInt(r14, r2, r4)
                int r14 = android.support.compat.C0022R.C0024id.icon
                int r4 = android.support.compat.C0022R.C0023drawable.notification_template_icon_bg
                r7.setInt(r14, r2, r4)
            L_0x004e:
                android.support.v4.app.NotificationCompat$Builder r14 = r12.mBuilder
            ...
            L_0x006e:
                ...
                int r14 = android.support.compat.C0022R.C0024id.right_icon
                r7.setImageViewBitmap(r14, r13)
                goto L_0x00af
            L_0x00a0:
                int r13 = android.support.compat.C0022R.C0024id.right_icon
                android.support.v4.app.NotificationCompat$Builder r14 = r12.mBuilder
            ...
            L_0x00b5:
                ...
                int r13 = r13.icon
                if (r13 == 0) goto L_0x00fc
                int r13 = android.support.compat.C0022R.C0024id.icon
                r7.setViewVisibility(r13, r9)
            ...
            L_0x00fc:
                ...
                int r14 = android.support.compat.C0022R.C0024id.title
                r7.setTextViewText(r14, r13)
            L_0x0107:
                android.support.v4.app.NotificationCompat$Builder r13 = r12.mBuilder
                java.lang.CharSequence r13 = r13.mContentText
                if (r13 == 0) goto L_0x0114
                int r14 = android.support.compat.C0022R.C0024id.text
                r7.setTextViewText(r14, r13)
                r13 = r8
                goto L_0x0115
            L_0x0114:
            ...
            L_0x0122:
                ...
                int r13 = android.support.compat.C0022R.C0024id.info
            ...
            L_0x0151:
                ...
                int r14 = android.support.compat.C0022R.C0024id.info
                android.support.v4.app.NotificationCompat$Builder r1 = r12.mBuilder
                int r1 = r1.mNumber
                long r1 = (long) r1
            ...
            L_0x0163:
                ...
                goto L_0x0132
            L_0x0169:
                int r1 = android.support.compat.C0022R.C0024id.info
            ...
            L_0x016e:
                ...
                int r2 = android.support.compat.C0022R.C0024id.text
                r7.setTextViewText(r2, r1)
                android.support.v4.app.NotificationCompat$Builder r1 = r12.mBuilder
                java.lang.CharSequence r1 = r1.mContentText
                if (r1 == 0) goto L_0x018f
                int r2 = android.support.compat.C0022R.C0024id.text2
                r7.setTextViewText(r2, r1)
                int r1 = android.support.compat.C0022R.C0024id.text2
            ...
            L_0x0195:
                ...
                float r15 = (float) r15
                int r0 = android.support.compat.C0022R.C0024id.text
                r7.setTextViewTextSize(r0, r9, r15)
            L_0x01a9:
                int r2 = android.support.compat.C0022R.C0024id.line1
                r3 = 0
                r4 = 0
                r5 = 0
                r6 = 0
            ...
            L_0x01b3:
                ...
                int r14 = android.support.compat.C0022R.C0024id.chronometer
                r7.setViewVisibility(r14, r9)
                int r14 = android.support.compat.C0022R.C0024id.chronometer
                ...
                long r2 = r2 - r4
                long r0 = r0 + r2
                java.lang.String r12 = "setBase"
                r7.setLong(r14, r12, r0)
                int r12 = android.support.compat.C0022R.C0024id.chronometer
                java.lang.String r14 = "setStarted"
                r7.setBoolean(r12, r14, r8)
                goto L_0x01ff
            L_0x01ed:
                int r14 = android.support.compat.C0022R.C0024id.time
                r7.setViewVisibility(r14, r9)
                int r14 = android.support.compat.C0022R.C0024id.time
                android.support.v4.app.NotificationCompat$Builder r12 = r12.mBuilder
                long r0 = r12.getWhenIfShowing()
            ...
            L_0x01ff:
                r14 = r8
            L_0x0200:
                int r12 = android.support.compat.C0022R.C0024id.right_side
            ...
            L_0x0207:
                ...
                int r12 = android.support.compat.C0022R.C0024id.line3
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0022R.C0023drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(C0022R.C0024id.notification_main_column);
            remoteViews.addView(C0022R.C0024id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0022R.C0024id.notification_main_column, 0);
            if (VERSION.SDK_INT >= 21) {
                remoteViews.setViewPadding(C0022R.C0024id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }

        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0022R.C0024id.title, 8);
            remoteViews.setViewVisibility(C0022R.C0024id.text2, 8);
            remoteViews.setViewVisibility(C0022R.C0024id.text, 8);
        }
