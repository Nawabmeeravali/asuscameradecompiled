...
import android.support.p000v4.media.session.MediaSessionCompat.Callback;
...
@TargetApi(19)
/* renamed from: android.support.v4.media.MediaSessionLegacyStub */
class MediaSessionLegacyStub extends Callback {
    ...
    /* renamed from: android.support.v4.media.MediaSessionLegacyStub$ControllerLegacyCb */
    final class ControllerLegacyCb extends ControllerCb {
        ...
        public void onCurrentMediaItemChanged(MediaItem2 mediaItem2) throws RemoteException {
            ...
            bundle2.putBundle("android.support.v4.media.argument.MEDIA_ITEM", bundle);
            this.mIControllerCallback.onEvent("android.support.v4.media.session.event.ON_CURRENT_MEDIA_ITEM_CHANGED", bundle2);
        }
    ...
    @FunctionalInterface
    /* renamed from: android.support.v4.media.MediaSessionLegacyStub$Session2Runnable */
