...
/* renamed from: android.support.v4.media.MediaPlaylistAgent */
public abstract class MediaPlaylistAgent {
    ...
    /* renamed from: android.support.v4.media.MediaPlaylistAgent$PlaylistEventCallback */
    ...
    /* renamed from: android.support.v4.media.MediaPlaylistAgent$RepeatMode */
    public @interface RepeatMode {
    }

    @RestrictTo({Scope.LIBRARY_GROUP})
    @Retention(RetentionPolicy.SOURCE)
    /* renamed from: android.support.v4.media.MediaPlaylistAgent$ShuffleMode */
