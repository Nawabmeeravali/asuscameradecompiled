...
import android.support.p000v4.media.subtitle.Cea608CCParser.MutableBackgroundColorSpan;
...
/* renamed from: android.support.v4.media.subtitle.ClosedCaptionRenderer */
public class ClosedCaptionRenderer extends Renderer {
    private Cea608CCWidget mCCWidget;
    private final Context mContext;

    /* renamed from: android.support.v4.media.subtitle.ClosedCaptionRenderer$Cea608CCWidget */
    class Cea608CCWidget extends ClosedCaptionWidget implements DisplayListener {
        ...
        /* renamed from: android.support.v4.media.subtitle.ClosedCaptionRenderer$Cea608CCWidget$CCLayout */
        ...
        /* renamed from: android.support.v4.media.subtitle.ClosedCaptionRenderer$Cea608CCWidget$CCLineBox */
        private class CCLineBox extends TextView {
            ...
            CCLineBox(Context context) {
                ...
                this.mOutlineWidth = (float) resources.getDimensionPixelSize(C0060R.dimen.subtitle_outline_width);
                this.mShadowRadius = (float) resources.getDimensionPixelSize(C0060R.dimen.subtitle_shadow_radius);
                this.mShadowOffset = (float) resources.getDimensionPixelSize(C0060R.dimen.subtitle_shadow_offset);
            }
    ...
    /* renamed from: android.support.v4.media.subtitle.ClosedCaptionRenderer$Cea608CaptionTrack */
