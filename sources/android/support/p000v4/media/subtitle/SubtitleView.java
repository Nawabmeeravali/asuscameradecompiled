...
@RequiresApi(28)
/* renamed from: android.support.v4.media.subtitle.SubtitleView */
class SubtitleView extends View {
    ...
    SubtitleView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mCornerRadius = (float) resources.getDimensionPixelSize(C0060R.dimen.subtitle_corner_radius);
        ...
        this.mShadowOffsetX = (float) resources.getDimensionPixelSize(C0060R.dimen.subtitle_shadow_offset);
