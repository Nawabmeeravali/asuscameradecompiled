...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl, ServiceCompatProxy {
        ...
        public android.support.p000v4.media.MediaBrowserServiceCompatApi21.BrowserRoot onGetRoot(java.lang.String r12, int r13, android.os.Bundle r14) {
            /*
                r11 = this;
                r0 = 0
                ...
                android.support.v4.media.MediaBrowserServiceCompat r2 = android.support.p000v4.media.MediaBrowserServiceCompat.this
                android.support.v4.media.MediaBrowserServiceCompat$ServiceHandler r2 = r2.mHandler
                r1.<init>(r2)
                r11.mMessenger = r1
                ...
                android.support.p000v4.app.BundleCompat.putBinder(r1, r3, r2)
                android.support.v4.media.MediaBrowserServiceCompat r2 = android.support.p000v4.media.MediaBrowserServiceCompat.this
            ...
            L_0x004e:
                r1 = r0
            L_0x004f:
                android.support.v4.media.MediaBrowserServiceCompat r9 = android.support.p000v4.media.MediaBrowserServiceCompat.this
                android.support.v4.media.MediaBrowserServiceCompat$ConnectionRecord r10 = new android.support.v4.media.MediaBrowserServiceCompat$ConnectionRecord
                r5 = -1
                r8 = 0
                r2 = r10
                r3 = r9
                ...
                android.support.v4.media.MediaBrowserServiceCompat r2 = android.support.p000v4.media.MediaBrowserServiceCompat.this
                android.support.v4.media.MediaBrowserServiceCompat$BrowserRoot r12 = r2.onGetRoot(r12, r13, r14)
                android.support.v4.media.MediaBrowserServiceCompat r11 = android.support.p000v4.media.MediaBrowserServiceCompat.this
                r11.mCurConnection = r0
            ...
            L_0x0073:
                ...
                r1.putAll(r11)
            L_0x0080:
                android.support.v4.media.MediaBrowserServiceCompatApi21$BrowserRoot r11 = new android.support.v4.media.MediaBrowserServiceCompatApi21$BrowserRoot
                java.lang.String r12 = r12.getRootId()
                r11.<init>(r12, r1)
                return r11
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p000v4.media.MediaBrowserServiceCompat.MediaBrowserServiceImplApi21.onGetRoot(java.lang.String, int, android.os.Bundle):android.support.v4.media.MediaBrowserServiceCompatApi21$BrowserRoot");
        }
                ...
                C01751 r1 = new Runnable() {
                    public void run() {
                        ...
                        if (connectionRecord.root == null) {
                            ...
                            sb.append(C01751.class.getName());
    ...
    private final class ServiceHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            String str3 = MediaBrowserProtocol.DATA_CALLING_UID;
            String str4 = MediaBrowserProtocol.DATA_CALLING_PID;
            String str5 = MediaBrowserProtocol.DATA_PACKAGE_NAME;
            String str6 = MediaBrowserProtocol.DATA_RESULT_RECEIVER;
            String str7 = MediaBrowserProtocol.DATA_MEDIA_ITEM_ID;
            switch (i) {
                case 1:
                    this.mServiceBinderImpl.connect(data.getString(str5), data.getInt(str4), data.getInt(str3), data.getBundle(str2), new ServiceCallbacksCompat(message.replyTo));
                    return;
                case 2:
                    this.mServiceBinderImpl.disconnect(new ServiceCallbacksCompat(message.replyTo));
                    return;
                case 3:
                    this.mServiceBinderImpl.addSubscription(data.getString(str7), BundleCompat.getBinder(data, str), data.getBundle(MediaBrowserProtocol.DATA_OPTIONS), new ServiceCallbacksCompat(message.replyTo));
                    return;
                case 4:
                ...
                case 5:
                    ...
                    return;
                case 6:
                    this.mServiceBinderImpl.registerCallbacks(new ServiceCallbacksCompat(message.replyTo), data.getString(str5), data.getInt(str4), data.getInt(str3), data.getBundle(str2));
                    return;
                case 7:
                    this.mServiceBinderImpl.unregisterCallbacks(new ServiceCallbacksCompat(message.replyTo));
                    return;
                case 8:
                    this.mServiceBinderImpl.search(data.getString(MediaBrowserProtocol.DATA_SEARCH_QUERY), data.getBundle(MediaBrowserProtocol.DATA_SEARCH_EXTRAS), (ResultReceiver) data.getParcelable(str6), new ServiceCallbacksCompat(message.replyTo));
                    return;
                case 9:
                    this.mServiceBinderImpl.sendCustomAction(data.getString(MediaBrowserProtocol.DATA_CUSTOM_ACTION), data.getBundle(MediaBrowserProtocol.DATA_CUSTOM_ACTION_EXTRAS), (ResultReceiver) data.getParcelable(str6), new ServiceCallbacksCompat(message.replyTo));
                    return;
                default:
                    StringBuilder sb = new StringBuilder();
    ...
    public void performLoadChildren(String str, ConnectionRecord connectionRecord, Bundle bundle, Bundle bundle2) {
        ...
        C01631 r0 = new Result<List<MediaItem>>(str) {
            /* access modifiers changed from: 0000 */
            public void onResultSent(List<MediaItem> list) {
                String str = "MBServiceCompat";
    ...
    public void performLoadItem(String str, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        C01642 r0 = new Result<MediaItem>(str) {
            /* access modifiers changed from: 0000 */
            public void onResultSent(MediaItem mediaItem) {
                if ((getFlags() & 2) != 0) {
    ...
    public void performSearch(String str, Bundle bundle, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        C01653 r0 = new Result<List<MediaItem>>(str) {
            /* access modifiers changed from: 0000 */
            public void onResultSent(List<MediaItem> list) {
    ...
    public void performCustomAction(String str, Bundle bundle, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        C01664 r0 = new Result<Bundle>(str) {
            /* access modifiers changed from: 0000 */
