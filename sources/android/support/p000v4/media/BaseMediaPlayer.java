...
@TargetApi(19)
/* renamed from: android.support.v4.media.BaseMediaPlayer */
public abstract class BaseMediaPlayer implements AutoCloseable {
    ...
    /* renamed from: android.support.v4.media.BaseMediaPlayer$BuffState */
    public @interface BuffState {
    }

    /* renamed from: android.support.v4.media.BaseMediaPlayer$PlayerEventCallback */
    ...
    @RestrictTo({Scope.LIBRARY_GROUP})
    @Retention(RetentionPolicy.SOURCE)
    /* renamed from: android.support.v4.media.BaseMediaPlayer$PlayerState */
