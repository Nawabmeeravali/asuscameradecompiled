...
import android.support.annotation.C0018Px;
...
public class ViewCompat {
    ...
    static class UnhandledKeyEventManager {
        ...
        static UnhandledKeyEventManager m6at(View view) {
            UnhandledKeyEventManager unhandledKeyEventManager = (UnhandledKeyEventManager) view.getTag(C0022R.C0024id.tag_unhandled_key_event_manager);
            if (unhandledKeyEventManager != null) {
                return unhandledKeyEventManager;
            }
            UnhandledKeyEventManager unhandledKeyEventManager2 = new UnhandledKeyEventManager();
            view.setTag(C0022R.C0024id.tag_unhandled_key_event_manager, unhandledKeyEventManager2);
        ...
        public boolean onUnhandledKeyEvent(@NonNull View view, @NonNull KeyEvent keyEvent) {
            ArrayList arrayList = (ArrayList) view.getTag(C0022R.C0024id.tag_unhandled_key_listeners);
            if (arrayList != null) {
    ...
    public static void setPaddingRelative(@NonNull View view, @C0018Px int i, @C0018Px int i2, @C0018Px int i3, @C0018Px int i4) {
        if (VERSION.SDK_INT >= 17) {
    ...
    @Deprecated
    public static void setAlpha(View view, @FloatRange(from = 0.0d, mo101to = 1.0d) float f) {
        view.setAlpha(f);
    }
    ...
    public static void addOnUnhandledKeyEventListener(@NonNull View view, @NonNull OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
        if (BuildCompat.isAtLeastP()) {
            Map map = (Map) view.getTag(C0022R.C0024id.tag_unhandled_key_listeners);
            if (map == null) {
                map = new ArrayMap();
                view.setTag(C0022R.C0024id.tag_unhandled_key_listeners, map);
            }
        ...
        if (arrayList == null) {
            ...
            view.setTag(C0022R.C0024id.tag_unhandled_key_listeners, arrayList);
        }
    ...
    public static boolean dispatchUnhandledKeyEventPre(View view, KeyEvent keyEvent) {
        ...
        if (UnhandledKeyEventManager.m6at(view).hasFocus() && UnhandledKeyEventManager.m6at(view).dispatch(view, keyEvent)) {
            z = true;
        }
        return z;
    }
