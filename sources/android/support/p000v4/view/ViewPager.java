...
public class ViewPager extends ViewGroup {
    ...
    public interface OnPageChangeListener {
        ...
        void onPageScrolled(int i, float f, @C0018Px int i2);
    ...
    public void populate(int r18) {
        ...
        L_0x0226:
            ...
            r3.append(r1)
            java.lang.Class<android.support.v4.view.ViewPager> r1 = android.support.p000v4.view.ViewPager.class
            r3.append(r1)
        ...
        for (int i14 = 0; i14 < childCount2; i14++) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (layoutParams2 == null || !layoutParams2.isDecor) {
                    childAt2.measure(MeasureSpec.makeMeasureSpec((int) (((float) i5) * layoutParams2.widthFactor), 1073741824), this.mChildHeightMeasureSpec);
                }
            }
        }
    }
