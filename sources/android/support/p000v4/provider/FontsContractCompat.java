...
public class FontsContractCompat {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:37:0x0089, code lost:
        sBackgroundThread.postAndReply(r1, new android.support.p000v4.provider.FontsContractCompat.C04283());
     */
        ...
        try {
            ...
            if (cursor != null && cursor.getCount() > 0) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    FontInfo fontInfo = new FontInfo(uri, i2, columnIndex5 != -1 ? cursor.getInt(columnIndex5) : AnimationManager.SHRINK_DURATION, columnIndex6 != -1 && cursor.getInt(columnIndex6) == 1, i);
