...
public final class OperationBuilder {
    ...
    public OperationBuilder addInput(Output<?> output) {
        Reference ref = this.graph.ref();
        try {
            addInput(this.unsafeNativeHandle, output.mo8356op().getUnsafeNativeHandle(), output.index());
            return this;
        } finally {
            ref.close();
        }
    ...
    public OperationBuilder addInputList(Output<?>[] outputArr) {
        ...
        try {
            ...
            for (int i = 0; i < outputArr.length; i++) {
                jArr[i] = outputArr[i].mo8356op().getUnsafeNativeHandle();
    ...
    public OperationBuilder setAttr(String str, DataType dataType) {
        Reference ref = this.graph.ref();
        try {
            setAttrType(this.unsafeNativeHandle, str, dataType.mo8304c());
            return this;
        } finally {
            ref.close();
        }
