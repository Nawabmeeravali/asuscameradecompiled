...
public final class Tensor<T> implements AutoCloseable {
    ...
    /* renamed from: org.tensorflow.Tensor$1 */
    static /* synthetic */ class C09141 {
        ...
        static {
            /*
                org.tensorflow.DataType[] r0 = org.tensorflow.DataType.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                $SwitchMap$org$tensorflow$DataType = r0
                int[] r0 = $SwitchMap$org$tensorflow$DataType     // Catch:{ NoSuchFieldError -> 0x0014 }
                org.tensorflow.DataType r1 = org.tensorflow.DataType.FLOAT     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                int[] r0 = $SwitchMap$org$tensorflow$DataType     // Catch:{ NoSuchFieldError -> 0x001f }
                org.tensorflow.DataType r1 = org.tensorflow.DataType.INT32     // Catch:{ NoSuchFieldError -> 0x001f }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001f }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001f }
            L_0x001f:
                int[] r0 = $SwitchMap$org$tensorflow$DataType     // Catch:{ NoSuchFieldError -> 0x002a }
                org.tensorflow.DataType r1 = org.tensorflow.DataType.DOUBLE     // Catch:{ NoSuchFieldError -> 0x002a }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x002a }
                r2 = 3
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x002a }
            L_0x002a:
                int[] r0 = $SwitchMap$org$tensorflow$DataType     // Catch:{ NoSuchFieldError -> 0x0035 }
                org.tensorflow.DataType r1 = org.tensorflow.DataType.INT64     // Catch:{ NoSuchFieldError -> 0x0035 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0035 }
                r2 = 4
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0035 }
            L_0x0035:
                int[] r0 = $SwitchMap$org$tensorflow$DataType     // Catch:{ NoSuchFieldError -> 0x0040 }
                org.tensorflow.DataType r1 = org.tensorflow.DataType.BOOL     // Catch:{ NoSuchFieldError -> 0x0040 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0040 }
                r2 = 5
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0040 }
            L_0x0040:
                int[] r0 = $SwitchMap$org$tensorflow$DataType     // Catch:{ NoSuchFieldError -> 0x004b }
                org.tensorflow.DataType r1 = org.tensorflow.DataType.UINT8     // Catch:{ NoSuchFieldError -> 0x004b }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x004b }
                r2 = 6
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x004b }
            L_0x004b:
                int[] r0 = $SwitchMap$org$tensorflow$DataType     // Catch:{ NoSuchFieldError -> 0x0056 }
                org.tensorflow.DataType r1 = org.tensorflow.DataType.STRING     // Catch:{ NoSuchFieldError -> 0x0056 }
            ...
            L_0x0056:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.tensorflow.Tensor.C09141.<clinit>():void");
        }
    }
    ...
    private static Tensor<?> create(Object obj, DataType dataType) {
        ...
        DataType dataType2 = tensor.dtype;
        if (dataType2 != DataType.STRING) {
            tensor.nativeHandle = allocate(tensor.dtype.mo8304c(), tensor.shapeCopy, (long) (elemByteSize(dataType2) * numElements(tensor.shapeCopy)));
            setValue(tensor.nativeHandle, obj);
        } else {
            long[] jArr = tensor.shapeCopy;
            if (jArr.length != 0) {
                tensor.nativeHandle = allocateNonScalarBytes(jArr, (Object[]) obj);
            } else {
    ...
    private static <T> Tensor<T> allocateForBuffer(DataType dataType, long[] jArr, int i) {
        ...
        tensor.nativeHandle = allocate(tensor.dtype.mo8304c(), tensor.shapeCopy, (long) i);
        return tensor;
    }
    ...
    public void writeTo(IntBuffer intBuffer) {
        ...
        throw incompatibleBuffer((Buffer) intBuffer, dataType);
    }
    ...
    public void writeTo(FloatBuffer floatBuffer) {
        ...
        throw incompatibleBuffer((Buffer) floatBuffer, dataType);
    }
    ...
    public void writeTo(DoubleBuffer doubleBuffer) {
        ...
        throw incompatibleBuffer((Buffer) doubleBuffer, dataType);
    }
    ...
    public void writeTo(LongBuffer longBuffer) {
        ...
        throw incompatibleBuffer((Buffer) longBuffer, dataType);
    }
    ...
    private static int elemByteSize(DataType dataType) {
        switch (C09141.$SwitchMap$org$tensorflow$DataType[dataType.ordinal()]) {
            case 1:
            case 2:
                return 4;
            case 3:
    ...
    private static boolean objectCompatWithType(Object obj, DataType dataType) {
        Class<String> baseObjType = baseObjType(obj);
    ...
    private void throwExceptionIfTypeIsIncompatible(Object obj) {
        ...
        if (numDimensions2 != numDimensions) {
            throw new IllegalArgumentException(String.format("cannot copy Tensor with %d dimensions into an object with %d", new Object[]{Integer.valueOf(numDimensions), Integer.valueOf(numDimensions2)}));
