...
final class NativeLibrary {
    ...
    private static String extractResource(InputStream inputStream, String str, String str2) throws IOException {
        ...
        sb.append(file2);
        log(sb.toString());
        log(String.format("copied %d bytes to %s", new Object[]{Long.valueOf(copy(inputStream, file)), file2}));
        return file2;
    }

    /* renamed from: os */
    private static String m21os() {
        ...
        String str2 = "darwin";
        if (lowerCase.contains("os x") || lowerCase.contains(str2)) {
            return str2;
        }
        String str3 = "windows";
        ...
        return lowerCase.replaceAll("\\s", BuildConfig.FLAVOR);
    }
    ...
    private static String makeResourceName(String str) {
        ...
        sb.append(String.format("%s-%s/", new Object[]{m21os(), architecture()}));
        sb.append(str);
        return sb.toString();
    }
